        ...
        <div className="px-20 mt-28 outerBox">
            <div style={{ height: "550px" }} className='bg-bgBlue blueBox relative rounded-3xl flex flex-col md:flex-row overflow-hidden'>
                    ...
                    <div className='pl-20 adjustPadding flex items-center justify-start flex-col'>
                        ...
                        <div className="flex gap-7 items-center  w-full">
                            <img
                                ...
                                className="cursor-pointer applestore"
                            />
                ...
                <div className='basis-1/2 flex items-center justify-center w-full'>
                    ...
                    <div className='h-64 w-64 flex items-center '><img className='h-full w-full'height={100} width={100} src="/mobile.svg" alt="" /></div>
                    {/* </div> */}
                    {/* dashed circular div */}
                    <motion.div
                        whileInView="visible"
                        ...
                        {/* red ghost */}
                        <motion.div whileInView="visible" viewport={{ once: true }} animate={{ rotate: -360 }} transition={{ type: "spring", duration: 4, bounce: 0.4 }} style={{ top: "55px" }} className='absolute h-16 w-12'><img height={100} width={100} className='h-full w-full' src="/blue-ghost.png" alt="blueGhooost" /></motion.div>
                        {/* blue ghost */}
                        <motion.div whileInView="visible" viewport={{ once: true }} animate={{ rotate: -360 }} transition={{ type: "spring", duration: 4, bounce: 0.4 }} style={{ right: "-30px", top: "50%", transform: "translate(-50%,-50%)" }} className='absolute h-16 w-14'><img height={100} width={100} className='h-full w-full' src="/red-ghost.png" alt="redGhossst" /></motion.div>
                        {/* voilet ghost */}
                        <motion.div whileInView="visible" viewport={{ once: true }} animate={{ rotate: -360 }} transition={{ type: "spring", duration: 4, bounce: 0.4 }} style={{ bottom: "-22px", right: "50%" }} className='absolute h-14 w-12'><img height={100} width={100} src="/newGhost.png" alt="newGhost" /></motion.div>
                    </motion.div>
                </div>
                ...
                >
                    <img height={100} width={100} src="/leaf.png" alt="leaf" />
                </motion.div>
