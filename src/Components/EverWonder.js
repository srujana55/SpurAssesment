...
import './EverWonder.css'

const EverWonder = () => {
  return (
    <section className="mt-16 mb-32 rounded-3xl bg-blue-50 blueBox p-10 mx-24">
      <motion.div
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true }}
      ...
      >
        ...
        <h1 className="text-[2.4rem] headingblue font-bold text-center mt-4">
      ...
      <div className="flex justify-center">
        <div className="mt-16 shadow bg-white rounded-xl w-[50rem] straight p-6 py-24 relative">
          <div className="flex justify-between ">
            <div className="h-4 w-4 rounded-full bg-violet-600 z-10 relative">
              ...
              >
                <div className="absolute straight text-white p-2 bg-violet-600 rounded top-[-3rem] left-[-3rem]">
                  You
                </div>
              </motion.div>
            </div>
